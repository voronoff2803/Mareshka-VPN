...
final public class OnboardViewController: UIViewController {
    ...
    public init(pageItems: [InfoScreenDTO],
    ...
    override public func loadView() {
        ...
        view.backgroundColor = UIColor(named: "LoaderColor")
        ...
        pageControlApperance.pageIndicatorTintColor = UIColor(named: "ColorTint")?.withAlphaComponent(0.3)
        pageControlApperance.currentPageIndicatorTintColor = UIColor(named: "ColorTint")
    ...
    private func pageViwControllerFor(pageIndex: Int) -> OnboardPageViewController? {
        let pageVC = OnboardPageViewController(pageIndex: pageIndex)
