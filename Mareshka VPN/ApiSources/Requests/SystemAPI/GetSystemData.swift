...
extension MatreshkaAPI.SystemAPI {
    ...
    public enum GetSystemData {

        public static let service = APIService<Response>(id: "getSystemData", tag: "System API", method: "GET", path: "/api/v1/system/", hasBody: false, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: GetSystemData.service)
            }
        }
