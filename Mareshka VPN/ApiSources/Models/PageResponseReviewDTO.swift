...
public class PageResponseReviewDTO: APIModel {

    public var data: [ReviewDTO]?
    ...
    public init(data: [ReviewDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseReviewDTO else { return false }
    ...
    public static func == (lhs: PageResponseReviewDTO, rhs: PageResponseReviewDTO) -> Bool {
