...
public class ServerDTO: APIModel {
    ...
    public init(address: String? = nil, certificateFile: String? = nil, city: String? = nil, country: String? = nil, countryCode: String? = nil, enabled: Bool? = nil, id: ID? = nil, lastUpdate: DateTime? = nil, maxClients: Int? = nil, nowClients: Int? = nil) {
