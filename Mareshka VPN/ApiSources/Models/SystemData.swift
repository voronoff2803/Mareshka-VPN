...
public class SystemData: APIModel {
    ...
    public var mainAd: String?

    public var promocodeOwnerBallEarn: Int?

    public init(appleModeration: Bool? = nil, bannerRedirect: String? = nil, discount: Int? = nil, discountType: DiscountType? = nil, enablePromos: Bool? = nil, mainAd: String? = nil, promocodeOwnerBallEarn: Int? = nil) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        mainAd = try container.decodeIfPresent("mainAd")
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(mainAd, forKey: "mainAd")
        try container.encodeIfPresent(promocodeOwnerBallEarn, forKey: "promocodeOwnerBallEarn")
    }

    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SystemData else { return false }
      ...
      guard self.mainAd == object.mainAd else { return false }
