...
public class RedirectView: APIModel {
    ...
    public class ServletContext: APIModel {
        ...
        public init(attributeNames: [String: Any]? = nil, classLoader: ClassLoader? = nil, contextPath: String? = nil, defaultSessionTrackingModes: [DefaultSessionTrackingModes]? = nil, effectiveMajorVersion: Int? = nil, effectiveMinorVersion: Int? = nil, effectiveSessionTrackingModes: [EffectiveSessionTrackingModes]? = nil, filterRegistrations: [String: Any]? = nil, initParameterNames: [String: Any]? = nil, jspConfigDescriptor: JspConfigDescriptor? = nil, majorVersion: Int? = nil, minorVersion: Int? = nil, requestCharacterEncoding: String? = nil, responseCharacterEncoding: String? = nil, serverInfo: String? = nil, servletContextName: String? = nil, servletNames: [String: Any]? = nil, servletRegistrations: [String: Any]? = nil, servlets: [String: Any]? = nil, sessionCookieConfig: SessionCookieConfig? = nil, sessionTimeout: Int? = nil, sessionTrackingModes: [SessionTrackingModes]? = nil, virtualServerName: String? = nil) {
