...
public class TopicDTO: APIModel {
    ...
    public init(categories: [Categories]? = nil, content: String? = nil, createdAt: DateTime? = nil, id: ID? = nil, language: Language? = nil, platform: Platform? = nil, readTime: Int? = nil, subtitle: String? = nil, title: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? TopicDTO else { return false }
