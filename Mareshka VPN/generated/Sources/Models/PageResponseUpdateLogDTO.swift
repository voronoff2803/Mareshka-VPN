...
public class PageResponseUpdateLogDTO: APIModel {

    public var data: [UpdateLogDTO]?
    ...
    public init(data: [UpdateLogDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseUpdateLogDTO else { return false }
    ...
    public static func == (lhs: PageResponseUpdateLogDTO, rhs: PageResponseUpdateLogDTO) -> Bool {
