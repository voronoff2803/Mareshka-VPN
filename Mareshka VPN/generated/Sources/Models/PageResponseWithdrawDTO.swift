...
public class PageResponseWithdrawDTO: APIModel {

    public var data: [WithdrawDTO]?
    ...
    public init(data: [WithdrawDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseWithdrawDTO else { return false }
    ...
    public static func == (lhs: PageResponseWithdrawDTO, rhs: PageResponseWithdrawDTO) -> Bool {
