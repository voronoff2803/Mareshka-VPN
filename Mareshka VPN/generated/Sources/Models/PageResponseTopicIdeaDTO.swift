...
public class PageResponseTopicIdeaDTO: APIModel {

    public var data: [TopicIdeaDTO]?
    ...
    public init(data: [TopicIdeaDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseTopicIdeaDTO else { return false }
    ...
    public static func == (lhs: PageResponseTopicIdeaDTO, rhs: PageResponseTopicIdeaDTO) -> Bool {
