...
public class PageResponseServerDTO: APIModel {

    public var data: [ServerDTO]?
    ...
    public init(data: [ServerDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseServerDTO else { return false }
    ...
    public static func == (lhs: PageResponseServerDTO, rhs: PageResponseServerDTO) -> Bool {
