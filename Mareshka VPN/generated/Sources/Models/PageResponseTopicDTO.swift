...
public class PageResponseTopicDTO: APIModel {

    public var data: [TopicDTO]?
    ...
    public init(data: [TopicDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseTopicDTO else { return false }
    ...
    public static func == (lhs: PageResponseTopicDTO, rhs: PageResponseTopicDTO) -> Bool {
