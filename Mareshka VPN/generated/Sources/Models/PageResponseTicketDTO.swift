...
public class PageResponseTicketDTO: APIModel {

    public var data: [TicketDTO]?
    ...
    public init(data: [TicketDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseTicketDTO else { return false }
    ...
    public static func == (lhs: PageResponseTicketDTO, rhs: PageResponseTicketDTO) -> Bool {
