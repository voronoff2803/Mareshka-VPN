...
public class EditTopicRequest: APIModel {
    ...
    public init(categories: [Categories]? = nil, content: String? = nil, language: Language? = nil, platform: Platform? = nil, readTime: Int? = nil, subtitle: String? = nil, title: String? = nil, topicId: ID? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EditTopicRequest else { return false }
      ...
      guard self.topicId == object.topicId else { return false }
      return true
    }

    public static func == (lhs: EditTopicRequest, rhs: EditTopicRequest) -> Bool {
