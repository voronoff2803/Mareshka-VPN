...
public class PageResponseInfoScreenDTO: APIModel {

    public var data: [InfoScreenDTO]?
    ...
    public init(data: [InfoScreenDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseInfoScreenDTO else { return false }
    ...
    public static func == (lhs: PageResponseInfoScreenDTO, rhs: PageResponseInfoScreenDTO) -> Bool {
