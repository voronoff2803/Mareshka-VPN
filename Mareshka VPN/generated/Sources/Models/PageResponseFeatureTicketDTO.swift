...
public class PageResponseFeatureTicketDTO: APIModel {

    public var data: [FeatureTicketDTO]?
    ...
    public init(data: [FeatureTicketDTO]? = nil, page: Int? = nil, pageCount: Int? = nil, totalElements: Int? = nil) {
        self.data = data
        self.page = page
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageResponseFeatureTicketDTO else { return false }
    ...
    public static func == (lhs: PageResponseFeatureTicketDTO, rhs: PageResponseFeatureTicketDTO) -> Bool {
