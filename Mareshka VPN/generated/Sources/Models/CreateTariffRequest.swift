...
public class CreateTariffRequest: APIModel {
    ...
    public init(ballCost: Int? = nil, bonus: Bool? = nil, chPrice: Double? = nil, discount: Int? = nil, duration: Int? = nil, durationType: DurationType? = nil, enPrice: Double? = nil, locale: Locale? = nil, name: String? = nil, ruPrice: Double? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CreateTariffRequest else { return false }
    ...
    public static func == (lhs: CreateTariffRequest, rhs: CreateTariffRequest) -> Bool {
