...
extension MatreshkaAPI.BillingAPIV2 {

    /** Сгенерировать Payment URL */
    public enum GeneratePaymentUrl {

        public static let service = APIService<Response>(id: "generatePaymentUrl", tag: "Billing API V2", method: "GET", path: "/api/v2/billing/robokassa/payment-url", hasBody: false, securityRequirements: [SecurityRequirement(type: "Bearer", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GeneratePaymentUrl.service)
            }
