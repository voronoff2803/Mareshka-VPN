...
extension MatreshkaAPI.AdminTicketAPI {
    ...
    public enum RemoveTicket {

        public static let service = APIService<Response>(id: "removeTicket", tag: "Admin - Ticket API", method: "DELETE", path: "/api/v1/admin/ticket/{ticketId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "Bearer", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RemoveTicket.service)
            }
