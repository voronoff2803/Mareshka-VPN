...
extension MatreshkaAPI.AdminInfoScreenAPI {
    ...
    /** (Админ-метод) Удаление экрана */
    public enum RemoveInfoScreen {

        public static let service = APIService<Response>(id: "removeInfoScreen", tag: "Admin - InfoScreen API", method: "DELETE", path: "/api/v1/admin/info-screen/{screenId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "Bearer", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RemoveInfoScreen.service)
            }
